...
int main(){
    ...
    pthread_t thread_rr;
    pthread_t thread_fcfs;

    pthread_create(&thread_rr, NULL, &run_rr_queue, NULL);
    pthread_create(&thread_fcfs, NULL, &run_fcfs_queue, NULL);
    ...
    printf("RR thread id: %d\n", rr_thread_id);
    printf("FCFS thread id: %d\n", fcfs_thread_id);
